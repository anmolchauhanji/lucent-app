...
const AgentKYC = () => {
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      {/* ================= HEADER ================= */}
      <div className="mb-6">
        <h1 className="text-3xl font-bold text-gray-900">Agent KYC</h1>
        <p className="text-gray-500 mt-1">Verify agent documents and details</p>
      </div>
          ...
          <tbody>
            {kycList.map((k) => (
              <tr key={k.id} className="border-b hover:bg-gray-50">
                <td className="py-3 font-medium">{k.agentName}</td>

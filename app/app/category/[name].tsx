    ...
    <View style={{ paddingTop: insets.top }} className="flex-1 bg-[#f8faf8]">
            ...
            return (
              ...
              >
                ...
                <View className="relative">
                  ...
                  >
                    <View className="w-full h-[100px] rounded-2xl bg-white/30 overflow-hidden">
                      <Image
                  ...
                  {(item.stockQuantity ?? 1) <= 0 ? (
                    ...
                    <Pressable
                      ...
                      className="absolute bottom-2 right-2 bg-white border border-pink-600 px-3 py-1 rounded-lg"
                    >
                      <Text className="text-pink-600 text-xs font-bold">ADD</Text>
                    </Pressable>
                  ) : (
                    <View className="absolute bottom-2 right-2 flex-row items-center bg-pink-600 rounded-lg overflow-hidden">
      ...
      >
        <Pressable
          ...
          className="flex-row items-center justify-between bg-teal-600 px-5 py-4 rounded-2xl"
        >
